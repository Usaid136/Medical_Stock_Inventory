...
<head>
    ...
    <title>Add New Medicine | Medical Store Inventory</title>
...
<body>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center medicine">Add New Medicine</h2>
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            //php query for inserting data
            $sql = "INSERT INTO medicines (`name`, `category`, `manufacturer`, `quantity`, `retail_price`, `wholesale_price`, `expiry_date`, `location`) 
            VALUES ('$name', '$category', '$manufacturer', $quantity, $price, $wholesale_price, '$expiry_date', '$location')";
            ...
            <strong>Insert failed!</strong> Please check the entered information and try again.
        ...
        <form id="addMedicineForm" method="POST" action="add_medicine.php" novalidate>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="category" name="category" required>
                    ...
                    <option>Human Other Items</option>
                    <option>General Item</option>
                    <option>Vet Inj 10ml</option>
                    <option>Vet Inj 50ml</option>
                    <option>Vet Inj 100ml</option>
                    <option>Vet Powder</option>
                    <option>Vet Tablets</option>
                    <option>Vet Other Items</option>
                    <option>Vet Tuips</option>
                    <option>Vet Drench 100ml</option>
                    <option>Vet Drench 1000ml</option>
                    <option>Vet Syrup</option>
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="manufacturer" name="manufacturer" required minlength="2" />
            ...
            <div class="mb-3">
                ...
                <input type="number" min="0.01" step="0.01" class="form-control" id="wholesale_price"
