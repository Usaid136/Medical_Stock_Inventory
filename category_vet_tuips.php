...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_vet_tuips.php" class="active fw-bold"><i class="bi bi-basket me-2"></i>Vet Tuips</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Vet Tuips</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Vet Tuips'";
