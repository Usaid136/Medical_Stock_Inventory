...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_medical_device.php" class="active fw-bold"><i class="bi bi-cpu me-2"></i>Medical Devices</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Medical Devices</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Medical Device'";
