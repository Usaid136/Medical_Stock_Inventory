...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_vet_inj_10ml.php" class="active fw-bold"><i class="bi bi-eyedropper me-2"></i>Vet Inj 10ml</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Vet Inj 10ml</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Vet Inj 10ml'";
