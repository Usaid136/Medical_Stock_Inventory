...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_vet_other_items.php" class="active fw-bold"><i class="bi bi-tools me-2"></i>Vet Other Items</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Vet Other Items</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Vet Other Items'";
