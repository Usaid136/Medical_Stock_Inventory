...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_topical.php" class="active fw-bold"><i class="bi bi-water me-2"></i>Topicals</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Topicals</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Topical'";
