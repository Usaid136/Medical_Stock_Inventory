...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_vet_drench_1000ml.php" class="active fw-bold"><i class="bi bi-bucket-fill me-2"></i>Vet Drench 1000ml</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Vet Drench 1000ml</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Vet Drench 1000ml'";
