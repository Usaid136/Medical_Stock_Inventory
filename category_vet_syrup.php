...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_vet_syrup.php" class="active fw-bold"><i class="bi bi-droplet me-2"></i>Vet Syrup</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Vet Syrups</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Vet Syrup'";
