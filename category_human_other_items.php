...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_human_other_items.php" class="active fw-bold"><i class="bi bi-bag-plus me-2"></i>Human Other Items</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Human Other Itemss</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Human Other Items'";
