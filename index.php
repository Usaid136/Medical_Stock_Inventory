...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="low_stock.php">
            ...
            Low Stock
            <span class="badge bg-secondary text-dark ms-1">(<?= $lowStockCount ?>)</span>
        </a>
        <a href="expiry_soon.php">
            <i class="bi bi-clock-fill"></i>
            Expiring Soon
            <span class="badge bg-secondary text-dark ms-1">(<?= $expiringSoonCount ?>)</span>
        </a>
        <h6 class="text-secondary text-uppercase ps-3 mt-4 mb-2">Human Pharmaceuticals</h6>
    ...
    <main class="main-content">
        ...
        <div class="table-responsive">
            ...
            <a href="add_medicine.php" class="btn btn-sm btn-success mt-3">
