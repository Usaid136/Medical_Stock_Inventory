...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_general_item.php" class="active fw-bold"><i class="bi bi-box-seam me-2"></i>General Items</a>
    </div>

    <!-- Main Content -->
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : General Items</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'General Item'";
