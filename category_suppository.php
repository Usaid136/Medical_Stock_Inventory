...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_suppository.php" class="active fw-bold"><i class="bi bi-diagram-3 me-2"></i>Suppositories</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Suppositories</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Suppository'";
