...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_drops.php" class="active fw-bold"><i class="bi bi-eyedropper me-2"></i>Drops</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Drops</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Drops'";
