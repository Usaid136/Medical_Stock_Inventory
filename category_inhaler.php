...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="category_inhaler.php" class="active fw-bold"><i class="bi bi-wind me-2"></i>Inhalers</a>
    ...
    <main class="main-content">
        <h2 class="mb-4 text-center">Category : Inhalers</h2>
            ...
            <table id="medicinesTable" class="table table-striped table-bordered align-middle">
                ...
                <tbody>
                    <!-- php start for fetching data -->
                     <?php
                     $sql = "SELECT * FROM `medicines` WHERE `category` = 'Inhaler'";
